...
export class MainCharacter {
    ...
    draw(context) {
        Rectangle.draw(this.position.add(this.velocity).x, this.position.add(this.velocity).y, 20, 20, this.lookDirectionAngles[this.lookDirection], '#8172ac');
    }
}
